# go-ruby-friendly-id documentation

**Pure-Go FriendlyId: slugs + slug history + friendly finder, CGO=0 — bound into rbgo**

`go-ruby-friendly-id/friendly-id` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `friendly-id`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-friendly-id/friendly-id`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `friendly-id`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`friendly-id`](https://github.com/go-ruby-friendly-id/friendly-id) | the library — Ruby's `friendly-id` in pure Go |
| [`docs`](https://github.com/go-ruby-friendly-id/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-friendly-id.github.io`](https://github.com/go-ruby-friendly-id/go-ruby-friendly-id.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-friendly-id/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-friendly-id/friendly-id](https://github.com/go-ruby-friendly-id/friendly-id).
